...
const hobbiesFifth = document.getElementById("hobbies-fifth")
const circleFifthHob = document.getElementById("circle-fifth-hob")
...
hobbiesFourth.addEventListener("mouseover", () => {
    circleFourthHob.classList.add("yellow")

})
hobbiesFourth.addEventListener("mouseout", () => {
    circleFourthHob.classList.remove("yellow")
